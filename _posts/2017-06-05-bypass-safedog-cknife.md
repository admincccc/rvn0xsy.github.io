...
![添加Shell](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x00.png)

接着为了方便分析，我们为当前条目添加上一个代理，通过`Burp`来分析与服务器端木马的交互数据。

![添加代理](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x01.png)

双击进行连接后，数据包到了我们的Burp中：

![分析数据](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x02.png)

可以看到已经被`WAF`拦截了：

![拦截截图](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x03.png)

那么我们深知，手工的话是不会被拦截的，为什么呢？

手工截图：

![手工](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x05.png)
...
![Success](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x06.png)

看来已经成功了。

查看进程：

![Command](http://rvn0xsy.oss-cn-shanghai.aliyuncs.com/2017-06-05/0x07.png)
